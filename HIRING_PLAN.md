...
7. **Reject fast, accept slowly.** If a candidate cannot articulate why FORA, the role, and the work matters to them, do not hire them.
...
## 3. Profile of a FORA founding engineer
...
- A clear "why FORA" answer. Mission-fit is non-negotiable.
...
3. **Technical loop (3 hours total)**
   - 60 min: take-home or live system design aligned to FORA's stack.
...
- The candidate articulates a clear reason FORA, the role, and the work matters to them.
...
- The candidate's "why FORA" is generic.
