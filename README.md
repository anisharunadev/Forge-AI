...
> Generated by the Documentation Agent ([Forge AI-120](/Forge AI/issues/Forge AI-120) / 7.1.2) from project memory + customer conventions. **Source SHA:** `forareal-final`. Re-running with the same inputs is a no-op (idempotency contract).
...
The public API surface is described in `docs/api/openapi.yaml` (generated by the [API docs generator](/Forge AI/issues/Forge AI-119) / 7.1.3).
...
Every PR is gated by the staged workflow ([Forge AI-23 — Documentation Agent Epic](/Forge AI/issues/Forge AI-23)); the [Forge AI-81 sub-goal 7.1](/Forge AI/issues/Forge AI-81) is the doc-generation contract.
...
<!-- TODO(generated): no `CHANGELOG.md` yet. The Changelog generator ([Forge AI-122](/Forge AI/issues/Forge AI-122) / 7.1.4) will create it on the next post-merge trigger. -->
