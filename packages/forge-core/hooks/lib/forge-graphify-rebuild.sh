#!/usr/bin/env bash
# forge-graphify-rebuild.sh — detached rebuild runner for hooks/forge-graphify-update.sh.
#
# Usage:
#   forge-graphify-rebuild.sh <STATUS_FILE> <LOCK_FILE> <HEAD_SHA> <MS_START> <GRAPHIFY_BIN>
#
