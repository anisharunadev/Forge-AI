...
For deep ecosystem research ("how do experts build this"), use `/forge:plan-phase --research-phase` which produces RESEARCH.md.
...
- Use `/forge:plan-phase --research-phase` for these
</guidelines>
