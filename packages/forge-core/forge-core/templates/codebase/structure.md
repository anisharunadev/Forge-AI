...
│   └── forge/           # GSD-specific commands
├── forge-core/     # Skill resources
...
**New Template:**
- Implementation: `forge-core/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `forge-core/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/forge-core/workflows/{name}.md`

**New Reference Document:**
- Implementation: `forge-core/references/{name}.md`
