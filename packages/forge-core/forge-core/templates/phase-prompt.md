...
<!-- For checkpoint task examples and patterns, see @~/.claude/forge-core/references/checkpoints.md -->
...
See `~/.claude/forge-core/references/tdd.md` for TDD plan structure.
...
See `~/.claude/forge-core/templates/user-setup.md` for full schema and examples
...
See `~/.claude/forge-core/workflows/verify-phase.md` for verification logic.
