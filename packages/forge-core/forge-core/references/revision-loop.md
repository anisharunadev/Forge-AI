...
|----------|---------------|---------------|-------|
| plan-phase | forge-planner | forge-plan-checker | Revision prompt via planner-revision.md |
| execute-phase | forge-executor | forge-verifier | Post-execution verification |
| discuss-phase | orchestrator | forge-plan-checker | Inline revision by orchestrator |
