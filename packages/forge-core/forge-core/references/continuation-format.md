...
- `/forge:discuss-phase 2 --assumptions` — check assumptions
...
- `/forge:plan-phase --research-phase 2` — investigate unknowns
- Review roadmap
...
- `/forge:plan-phase --research-phase 3` — investigate unknowns
...
**To research unknowns:** `/forge:plan-phase --research-phase 3`
