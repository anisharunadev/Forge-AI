...
```bash
# All forge-tools query commands accept --ws
forge-tools query state.json --ws feature-a
forge-tools query find-phase 3 --ws feature-b

# Session-local switching without --ws on every command
GSD_SESSION_KEY=my-terminal-a forge-tools query workstream.set feature-a
GSD_SESSION_KEY=my-terminal-a forge-tools query state.json
GSD_SESSION_KEY=my-terminal-b forge-tools query workstream.set feature-b
GSD_SESSION_KEY=my-terminal-b forge-tools query state.json

# Workstream CRUD
forge-tools query workstream.create <name>
forge-tools query workstream.list
forge-tools query workstream.status <name>
forge-tools query workstream.complete <name>
```
