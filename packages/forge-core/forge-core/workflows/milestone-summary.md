...
4. If nothing found: error "No milestone found. Run /forge:new-project or /forge:new-milestone first."
...
```bash
forge_run query commit "docs(v${VERSION}): generate milestone summary for onboarding" --files \
...
If the user is done:
- Suggest next steps: `/forge:new-milestone`, `/forge:progress`, or sharing the summary with the team
