...
- /forge:review — Run cross-AI peer review on a specific phase plan
- /forge:ship — Create a PR from completed work
- /forge:progress — See overall project state
- /forge:inbox --label — Re-run with auto-labeling enabled
</offer_next>
