...
function versionFile(dir) { return node_path_1.default.join(dir, 'forge-core', 'VERSION'); }
function markerFile(dir) { return node_path_1.default.join(dir, 'forge-core', 'workflows', 'update.md'); }
