"use strict";
/**
 * gsd2-import — Reverse migration from GSD-2 (.forge/) to GSD v1 (.planning/)
 *
...
// ─── GSD-2 Parser ───────────────────────────────────────────────────────────
/**
 * Find the .forge/ directory starting from a project root.
...
/**
 * Parse a complete GSD-2 .forge/ directory into a structured representation.
 */
...
// ─── Command Handler ──────────────────────────────────────────────────────────
/**
 * Entry point called from forge-tools.cjs.
...
function cmdFromGsd2(args, cwd, raw) {
    ...
    if (!gsdDir) {
        output({ success: false, error: `No .forge/ directory found in ${projectDir}` }, raw, undefined);
        return;
    }
