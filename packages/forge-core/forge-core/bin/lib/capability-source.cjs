...
function realHttpsGet(url) {
    return new Promise((resolve, reject) => {
        const req = _httpsGetImpl(url, { headers: { 'User-Agent': 'forge-core-capability-source/1.0' } }, (res) => {
...
function resolveGit(parsed, opts, gsdHome, hostVersion) {
    ...
    const cloneDir = node_fs_1.default.mkdtempSync(node_path_1.default.join(node_os_1.default.tmpdir(), 'forge-cap-git-'));
    try {
...
function resolveNpm(parsed, opts, gsdHome, hostVersion) {
    ...
    const tmpPackDir = node_fs_1.default.mkdtempSync(node_path_1.default.join(node_os_1.default.tmpdir(), 'forge-cap-npm-pack-'));
    const extractDir = node_fs_1.default.mkdtempSync(node_path_1.default.join(node_os_1.default.tmpdir(), 'forge-cap-npm-ext-'));
    try {
...
async function resolveTarball(parsed, opts, gsdHome, hostVersion) {
    ...
    const extractDir = node_fs_1.default.mkdtempSync(node_path_1.default.join(node_os_1.default.tmpdir(), 'forge-cap-tar-'));
