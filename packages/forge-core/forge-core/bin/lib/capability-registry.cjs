...
const capabilities = {
  ...
  "audit": {
    ...
    "version": "1.6.0-rc.3",
    "title": "Audit",
    "description": "Open-artifact audit and UAT-gap audit for milestone close gates; exposes `forge-tools audit-uat` (cross-phase UAT outstanding items) and `forge-tools audit-open` (structured open-artifact scan across debug, tasks, threads, todos, seeds, UAT, verification, context-questions).",
    "tier": "full",
    "requires": [],
    "engines": {
      "forge": ">=1.6.0"
  ...
  "drift": {
    ...
    "config": {
      ...
      "workflow.drift_action": {
        ...
        "default": "warn",
        "description": "Action taken by the codebase drift gate when the threshold is exceeded: warn (advisory message) or auto-remap (spawn forge-codebase-mapper agent to refresh STRUCTURE.md)."
      },
  ...
  "graphify": {
    ...
    "description": "Build, query, and inspect the project knowledge graph in `.planning/graphs/`; exposes graphify CLI subcommands (build, query, status, diff) and the /forge-graphify skill.",
    "tier": "full",
    "requires": [],
    "engines": {
      "forge": ">=1.6.0"
  ...
  "hermes": {
    ...
    "version": "1.6.0-rc.3",
    "title": "Hermes Agent",
    "description": "Hermes Agent (NousResearch) — skills nest under skills/forge/ category bucket; nested skill layout; settings-json hook surface; Claude hook event dialect; tier-2 support.",
    "tier": "core",
    "requires": [],
    "engines": {
      "forge": ">=1.6.0"
  ...
  "intel": {
    ...
    "description": "Code-intelligence store for codebase querying, diff, snapshot, and API-surface extraction; exposes `forge-tools intel` subcommands (query, status, update, diff, snapshot, patch-meta, validate, extract-exports, api-surface) and backs `/forge-map-codebase` and `forge-intel-updater`.",
    "tier": "full",
    "requires": [],
    "engines": {
      "forge": ">=1.6.0"
  ...
  "profile-pipeline": {
    ...
    "description": "Developer behavioral profiling from Claude Code session history; scans session JSONL files, extracts and samples user messages, and generates profile artifacts (USER-PROFILE.md, dev-preferences.md, CLAUDE.md sections). Exposes eight `forge-tools` commands: scan-sessions, extract-messages, profile-sample (pipeline phase) and write-profile, profile-questionnaire, generate-dev-preferences, generate-claude-profile, generate-claude-md (output phase). Backs the /forge-profile-user skill and forge-user-profiler agent.",
    "tier": "full",
    "requires": [],
    "engines": {
      "forge": ">=1.6.0"
...
const byAgent = {
  "forge-framework-selector": "ai-integration",
  "gsd-ai-researcher": "ai-integration",
  "forge-domain-researcher": "ai-integration",
  "forge-eval-planner": "ai-integration",
  "forge-code-reviewer": "code-review",
  "forge-code-fixer": "code-review",
  "gsd-mempalace-curator": "mempalace",
  "gsd-nyquist-auditor": "nyquist",
  "forge-pattern-mapper": "pattern-mapper",
  "gsd-user-profiler": "profile-pipeline",
  "forge-phase-researcher": "research",
  "forge-security-auditor": "security",
  "forge-ui-checker": "ui",
  "forge-ui-auditor": "ui"
};
