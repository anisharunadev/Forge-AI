 ...
 * (#1259, ADR-550 Decision 5d "heavy half"; the D1 seam — a NEW deterministic forge-tools
 ...
 * `forge-core/bin/lib/prohibition-enforcement.cjs`. Do NOT hand-write the `.cjs`; it is emitted.
 *
...
/**
 * CLI surface: `forge_run check prohibition-enforcement <request.json>` (or `--json '<inline>'`).
