...
<execution_context>
@~/.claude/forge-core/workflows/execute-phase.md
...
Context files are resolved inside the workflow via `forge-tools query init.execute-phase` and per-subagent `<files_to_read>` blocks.
</context>
