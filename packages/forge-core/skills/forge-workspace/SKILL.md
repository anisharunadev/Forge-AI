...
| --list | Scan ~/forge-workspaces/, show summary table | list-workspaces |
| --remove | Confirm and remove workspace directory | remove-workspace |

</routing>

<execution_context>
@~/.claude/forge-core/workflows/new-workspace.md
@~/.claude/forge-core/workflows/list-workspaces.md
@~/.claude/forge-core/workflows/remove-workspace.md
