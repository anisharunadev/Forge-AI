...
<execution_context>
@~/.claude/forge-core/workflows/add-todo.md
@~/.claude/forge-core/workflows/note.md
@~/.claude/forge-core/workflows/add-backlog.md
@~/.claude/forge-core/workflows/plant-seed.md
@~/.claude/forge-core/workflows/check-todos.md
@~/.claude/forge-core/workflows/list-seeds.md
