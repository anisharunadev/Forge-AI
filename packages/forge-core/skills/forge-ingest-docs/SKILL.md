...
- **Net-new bootstrap** (`--mode new`, default when `.planning/` is absent): produces PROJECT.md + REQUIREMENTS.md + ROADMAP.md + STATE.md from synthesized doc content, delegating final generation to `forge-roadmapper`.
...
<execution_context>
@~/.claude/forge-core/workflows/ingest-docs.md
