...
<execution_context>
@~/.claude/forge-core/workflows/spec-phase.md
@~/.claude/forge-core/templates/spec.md
</execution_context>
...
- User knows they can now run /forge:discuss-phase which will load SPEC.md automatically
</success_criteria>
