...
Review and comment on the plan in your browser, then import it back via /forge:import --from.

⚠ BETA: ultraplan is in research preview. Use /forge:plan-phase for stable local planning.
Requirements: Claude Code v2.1.91+, claude.ai account, GitHub repository.
</objective>

<execution_context>
@~/.claude/forge-core/workflows/ultraplan-phase.md
