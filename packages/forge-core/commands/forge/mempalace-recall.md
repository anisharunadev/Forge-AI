...
**DO NOT use `forge-tools config get-value`** -- it hard-exits on missing keys.
...
MemPalace memory is disabled. To activate:
  ...
  node <runtime-home>/forge-core/bin/forge-tools.cjs config-set mempalace.enabled true
