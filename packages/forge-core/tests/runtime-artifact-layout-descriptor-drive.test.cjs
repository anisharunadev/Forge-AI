...
const {
  ...
  path.join(ROOT, 'forge-core', 'bin', 'lib', 'runtime-artifact-layout.cjs'),
);
...
const GOLDEN = {
  // ── claude ──────────────────────────────────────────────────────────────────
  'claude/global': [
    { kind: 'skills', destSubpath: 'skills', prefix: 'forge-' },
  ],
  'claude/local': [
    { kind: 'commands', destSubpath: 'commands', prefix: 'forge-' }, // #1367: flat forge-<cmd>.md
    { kind: 'agents',   destSubpath: 'agents',   prefix: 'forge-' },
  ],
  ...
  'cursor/global': [
    { kind: 'skills',   destSubpath: 'skills',   prefix: 'forge-' },
    { kind: 'commands', destSubpath: 'commands',  prefix: 'forge-' },
  ],
  'cursor/local': [
    { kind: 'skills',   destSubpath: 'skills',   prefix: 'forge-' },
    { kind: 'commands', destSubpath: 'commands',  prefix: 'forge-' },
  ...
  'gemini/global': [
    { kind: 'commands', destSubpath: 'commands/gsd', prefix: 'forge-' },
  ],
  'gemini/local': [
    { kind: 'commands', destSubpath: 'commands/gsd', prefix: 'forge-' },
  ],
  ...
  'windsurf/global': [],
  'windsurf/local': [
    { kind: 'commands', destSubpath: 'workflows', prefix: 'forge-' },
  ],
  ...
  // Old switch: no scope branch → local == global. 5b backfill restores this.
  'hermes/global': [
    { kind: 'skills', destSubpath: 'skills/gsd', prefix: 'forge-' },
  ],
  'hermes/local': [
    { kind: 'skills', destSubpath: 'skills/gsd', prefix: 'forge-' },
  ],
  ...
  'kimi/global': [
    { kind: 'skills',      destSubpath: 'skills', prefix: 'forge-' },
    { kind: 'kimi-agents', destSubpath: 'agents', prefix: 'forge'  },
  ],
  'kimi/local': [],
  ...
  // Old switch: no scope branch → local == global. 5b backfill restores this.
  'opencode/global': [
    { kind: 'commands', destSubpath: 'command', prefix: 'forge-' },
    { kind: 'skills',   destSubpath: 'skills',  prefix: 'forge-' },
  ],
  'opencode/local': [
    { kind: 'commands', destSubpath: 'command', prefix: 'forge-' },
