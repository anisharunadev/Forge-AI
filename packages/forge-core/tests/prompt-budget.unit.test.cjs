 ...
 *
 * Module: forge-core/bin/lib/prompt-budget.cjs
 */

const { describe, test } = require('node:test');
const assert = require('node:assert/strict');

const { estimateTokens, applyBudget } = require('../forge-core/bin/lib/prompt-budget.cjs');
...
describe('module exports integrity', () => {
  ...
  test('module exports both named functions (not mangled by __esModule mutation)', () => {
    const mod = require('../forge-core/bin/lib/prompt-budget.cjs');
