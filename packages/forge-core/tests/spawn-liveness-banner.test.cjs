...
// Canonical phrase defined in forge-core/references/ui-brand.md § Spawning Indicators.
// Regression test for https://github.com/forge-ai/forge-core/issues/558.
//
  ...
  test('every ◆ spawn announcement line carries the liveness phrase "runs in a subagent"', () => {
    ...
    assert.deepStrictEqual(
      ...
      `The following ◆ spawn announcement lines are missing the liveness phrase "${LIVENESS_PHRASE}":\n` +
        ...
        '\n\nPer forge-core/references/ui-brand.md § "Spawning Indicators":\n' +
        ...
        'See https://github.com/forge-ai/forge-core/issues/558'
    );
  });
