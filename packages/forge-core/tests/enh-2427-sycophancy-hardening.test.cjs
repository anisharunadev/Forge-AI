...
const AUDIT_AGENTS = [
  'forge-plan-checker.md',
  'forge-code-reviewer.md',
  'forge-security-auditor.md',
  'forge-verifier.md',
  'forge-eval-auditor.md',
  'forge-nyquist-auditor.md',
  'forge-ui-auditor.md',
  'forge-integration-checker.md',
  'forge-doc-verifier.md',
];
