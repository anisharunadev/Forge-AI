...
// agents/forge-roadmapper.md is the deployed agent — the Granularity Calibration table
...
describe('forge-roadmapper granularity calibration (#163)', () => {
  const section = granularitySection(readAgent('forge-roadmapper'));
...
describe('forge-roadmapper phase_id_convention support (#1205)', () => {
  const content = readAgent('forge-roadmapper');
