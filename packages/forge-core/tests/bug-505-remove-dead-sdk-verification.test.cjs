 ...
 *
 * Post-ADR-0174 the `@openforge/forge-sdk` package was retired; `sdk/` no longer
...
describe('bug #505: dead SDK verification subsystem removed from bin/install.js', () => {
  ...
  // formatStaleStandaloneSdkWarning) and the forge-sdk shim contract surface
  // (buildWindowsShimTriple, formatSdkPathDiagnostic) that #505 kept were
  // removed when the forge-sdk shim itself was retired (#191). Their absence is
