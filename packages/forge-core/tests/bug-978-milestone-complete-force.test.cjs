...
/**
 * Regression test for bug #978: `forge-tools milestone complete --force` was a
 ...
 * CLI dispatcher (forge-core/bin/forge-tools.cjs) never parsed `--force` and never
...
describe('bug-978: milestone complete --force overrides unstarted-phase guard', () => {
  ...
  beforeEach(() => {
    tmpDir = createTempProject('forge-bug-978-');
  });
