/**
 * forge-executor agent — MVP+TDD gate section contract
...
const AGENT = path.join(__dirname, '..', 'agents', 'forge-executor.md');
const REF = path.join(__dirname, '..', 'forge-core', 'references', 'execute-mvp-tdd.md');

describe('forge-executor — MVP+TDD gate section', () => {
