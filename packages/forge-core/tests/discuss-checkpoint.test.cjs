...
describe('discuss-phase incremental checkpoint saves (#1485)', () => {
  ...
  const defaultModePath = path.join(__dirname, '..', 'forge-core', 'workflows', 'discuss-phase', 'modes', 'default.md');
  const checkpointTplPath = path.join(__dirname, '..', 'forge-core', 'workflows', 'discuss-phase', 'templates', 'checkpoint.json');
