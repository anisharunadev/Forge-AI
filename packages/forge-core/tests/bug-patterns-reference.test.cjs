...
const REFERENCE_PATH = path.join(
  __dirname, '..', 'forge-core', 'references', 'common-bug-patterns.md'
);
const DEBUGGER_AGENT_PATH = path.join(
  __dirname, '..', 'agents', 'forge-debugger.md'
);
...
describe('debugger agent references bug patterns', () => {
  ...
  test('forge-debugger.md references common-bug-patterns.md', () => {
