...
const WAVE_GUARD_PATH = path.join(__dirname, '..', 'forge-core', 'references', 'execute-phase-wave-guard.md');
const BETWEEN_WAVE_PATH = path.join(__dirname, '..', 'forge-core', 'references', 'execute-phase-between-wave-reset.md');
