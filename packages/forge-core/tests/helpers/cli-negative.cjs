 ...
 *
 * Wraps spawnSync of forge-core/bin/forge-tools.cjs so test files can
...
const TOOLS_PATH = path.resolve(__dirname, '..', '..', 'forge-core', 'bin', 'forge-tools.cjs');

/**
 * Run forge-tools with the given argv against a project directory.
 *
 * @param {string[]} argv - argument vector passed to forge-tools.cjs. Each
