...
// commands/forge/*.md files are the deployed skill surface. Their frontmatter
// IS the runtime contract. Checking frontmatter fields checks deployed behaviour.

/**
 * #3156 — plan-phase auto-dispatches to forge-planner subagent on OpenCode,
 * losing Task tool access.
 *
 * Root cause: commands/forge/plan-phase.md had `agent: forge-planner` in its
 ...
 *
 * This test parses the YAML frontmatter of every commands/forge/*.md file and
 * asserts:
