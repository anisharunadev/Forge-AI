 ...
 *
 * The template (forge-core/templates/roadmap.md) always uses this two-line form.
...
describe('regressions: insert missing plan rows (#1163)', () => {
  ...
  beforeEach(() => {
    tmpDir = createTempProject('forge-1163-');
...
describe('regressions: insert missing plan rows (#1163) — adversarial: partial gaps, canonical template, scoped insertion', () => {
  ...
  beforeEach(() => {
    tmpDir = createTempProject('forge-1163-adv-');
    roadmapPath = path.join(tmpDir, '.planning', 'ROADMAP.md');
  });
  ...
  // The canonical template (forge-core/templates/roadmap.md) uses:
