...
// This misses the {N}-PLAN-{NN}-{slug}.md layout that forge-plan-phase
...
const roadmapLib = path.join(ROOT, 'forge-core', 'bin', 'lib', 'roadmap.cjs');
const planScanLib = path.join(ROOT, 'forge-core', 'bin', 'lib', 'plan-scan.cjs');
