/**
 * forge-planner agent — MVP-mode branch contract
...
const AGENT = path.join(__dirname, '..', 'agents', 'forge-planner.md');
const REF_MVP = path.join(__dirname, '..', 'forge-core', 'references', 'planner-mvp-mode.md');
const REF_SKEL = path.join(__dirname, '..', 'forge-core', 'references', 'skeleton-template.md');

describe('forge-planner — MVP-mode branch', () => {
