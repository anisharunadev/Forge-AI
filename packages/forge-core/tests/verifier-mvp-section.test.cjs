/**
 * forge-verifier agent — MVP Mode Verification section contract
...
const AGENT = path.join(__dirname, '..', 'agents', 'forge-verifier.md');
const REF = path.join(__dirname, '..', 'forge-core', 'references', 'verify-mvp-mode.md');
...
describe('forge-verifier — MVP Mode Verification section', () => {
