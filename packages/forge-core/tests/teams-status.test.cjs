 ...
 * End-to-end tests use forge-tools CLI via spawnSync with explicit hermetic envs.
 */
...
const { resolveTeamsStatus } = require('../forge-core/bin/lib/teams-status.cjs');
...
describe('forge-tools query teams-status — CLI subprocess tests', () => {
