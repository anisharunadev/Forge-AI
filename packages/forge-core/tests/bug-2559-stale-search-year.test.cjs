 ...
 *
 * The forge-phase-researcher and forge-project-researcher agents instruct
...
const PHASE_RESEARCHER = path.join(
  ...
  '..',
  'agents',
  'forge-phase-researcher.md'
);
const PROJECT_RESEARCHER = path.join(
  __dirname,
  '..',
  'agents',
  'forge-project-researcher.md'
);

const FILES = [
  { label: 'forge-phase-researcher.md', path: PHASE_RESEARCHER },
  { label: 'forge-project-researcher.md', path: PROJECT_RESEARCHER },
];
