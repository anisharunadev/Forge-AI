 ...
 *
 * Also covers: `forge-tools roadmap validate` subcommand shape.
 *
...
describe('W021 — milestone-prefixed phase ID convention', () => {
  ...
  test("'forge-tools roadmap validate' subcommand returns JSON with warnings array", () => {
    buildRoadmap(tmpDir, [
      {
        version: 'v1.0',
        label: 'Foundation',
  ...
  test('W021 warning text includes the migration command', () => {
    ...
    const migrationCmd = 'forge-tools roadmap upgrade --convention milestone-prefixed';
