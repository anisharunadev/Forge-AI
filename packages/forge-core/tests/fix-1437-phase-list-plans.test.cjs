...
/**
 * Regression tests for `forge-tools query phase.list-plans <N>` (#1437).
 *
 ...
 *   forge-tools → phase-command-router → phase.cmdPhaseListPlans
 */
...
describe('bug-1437 — phase.list-plans is wired in forge-tools', () => {
