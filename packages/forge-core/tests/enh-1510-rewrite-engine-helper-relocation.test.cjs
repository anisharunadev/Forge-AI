...
//   - getDirName            -> forge-core/bin/lib/runtime-name-policy.cjs
//   - processAttribution    -> forge-core/bin/lib/runtime-artifact-conversion.cjs
...
const runtimeNamePolicy = require('../forge-core/bin/lib/runtime-name-policy.cjs');
