...
// Content-assertion contract for the forge-verifier agent: the
...
const standaloneTemplatePath = path.join(ROOT, 'forge-core', 'templates', 'verification-report.md');
...
const verifyPhase = fs.readFileSync(path.join(ROOT, 'forge-core', 'workflows', 'verify-phase.md'), 'utf-8');
