 ...
 *
 * The get_installed_version step was rewritten to call `forge-tools update-context`
 ...
 * (commands/gsd, forge-core), user-added files inside those dirs could be
 ...
 *
 * Source-text-is-the-product: update.md's bash blocks ARE the deployed /forge:update
...
const UPDATE_MD = path.join(__dirname, '..', 'forge-core', 'workflows', 'update.md');
