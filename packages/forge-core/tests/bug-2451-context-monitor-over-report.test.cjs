 ...
 *
 * forge-statusline.js writes two values to the bridge file:
 ...
 *     (100 - buffer) * 100
 *
 * forge-context-monitor.js displays used_pct (78%) in warning messages.
...
const HOOK_PATH = path.join(__dirname, '..', 'hooks', 'forge-statusline.js');
const MONITOR_PATH = path.join(__dirname, '..', 'hooks', 'forge-context-monitor.js');
