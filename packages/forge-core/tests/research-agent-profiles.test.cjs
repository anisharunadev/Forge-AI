...
// Step-C section of forge-phase-researcher.md and forge-project-researcher.md.
...
describe('research-agent-profiles: provider dispatch parity', () => {
  ...
  const SEAM_AGENTS = ['forge-phase-researcher', 'forge-project-researcher'];

  // Load PROVIDER_WATERFALL from the compiled seam module.
  const { PROVIDER_WATERFALL } = require('../forge-core/bin/lib/research-provider.cjs');
