...
const AUTONOMOUS_PATH = path.join(PROJECT_ROOT, 'forge-core', 'workflows', 'autonomous.md');
const SMART_DISCUSS_REF = path.join(PROJECT_ROOT, 'forge-core', 'references', 'autonomous-smart-discuss.md');
