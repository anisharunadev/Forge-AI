 ...
 *
 * After #3042 deleted /forge-research-phase (replaced by
 * /forge-plan-phase --research-phase <N>) and v1.40.0 consolidated /forge-insert-phase
 * into /forge-phase insert, six occurrences survived in agents/*.md because none of
 ...
 * runs the /forge- → /forge: namespace transform, not retired-name replacement.
 *
