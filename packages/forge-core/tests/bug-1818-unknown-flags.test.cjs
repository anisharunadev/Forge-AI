 ...
 *
 * Original #1818 invariant: forge-tools must NOT silently ignore --help/-h
 ...
 * subcommand discoverability for `forge-sdk query <subcommand> --help`.
 *
 ...
 *
 * --version remains rejected — it's never a valid forge-tools flag and has
