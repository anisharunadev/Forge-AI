...
const PROBE_CORE_LIB = path.join(__dirname, '..', 'forge-core', 'bin', 'lib', 'probe-core.cjs');
...
//
// RED-first: these assertions require the BUILT forge-core/bin/lib/prohibition-enforcement.cjs,
