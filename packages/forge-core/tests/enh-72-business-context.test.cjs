...
const TEMPLATE = path.join(__dirname, '..', 'forge-core', 'templates', 'project.md');
const COMPLETE_MILESTONE = path.join(__dirname, '..', 'forge-core', 'workflows', 'complete-milestone.md');
