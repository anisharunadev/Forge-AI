...
// commands/forge/*.md, forge-core/workflows/*.md, and agents/forge-*.md are
...
describe('#3168 — commands/forge: allowed-tools must use Agent not Task', () => {
...
describe('#3168 — agents: tools frontmatter must use Agent not Task', () => {
  const agents = readMdFiles(AGENTS_DIR, 'forge-');
