...
const { routeCjsCommandFamily, routeHubCommandFamily } = require('../forge-core/bin/lib/cjs-command-router-adapter.cjs');
const { makeInvalidArgs } = require('../forge-core/bin/lib/command-routing-hub.cjs');
