...
const executePlanPath = path.join(repoRoot, 'forge-core', 'workflows', 'execute-plan.md');
const planningConfigPath = path.join(repoRoot, 'forge-core', 'references', 'planning-config.md');
