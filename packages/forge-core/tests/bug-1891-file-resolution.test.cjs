...
// forge-tools.cjs @file: resolution is a low-level stdout interception that cannot be
 ...
 *
 * forge-tools.cjs must transparently resolve @file: references in stdout
...
const GSD_TOOLS_SRC = path.join(__dirname, '..', 'forge-core', 'bin', 'forge-tools.cjs');

describe('bug #1891: @file: resolution in forge-tools.cjs', () => {
  let src;
