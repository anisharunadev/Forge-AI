...
const SH_HOOKS = [
  { name: 'forge-validate-commit.sh', settingsVar: 'validateCommitCommand' },
  { name: 'forge-session-state.sh',   settingsVar: 'sessionStateCommand' },
  { name: 'forge-phase-boundary.sh',  settingsVar: 'phaseBoundaryCommand' },
];
