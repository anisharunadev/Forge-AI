...
const GSD_TOOLS = path.join(REPO_ROOT, 'forge-core', 'bin', 'forge-tools.cjs');
...
function createProject() {
  const dir = fs.mkdtempSync(path.join(os.tmpdir(), 'forge-3251-dispatch-'));
...
describe('feat-3251: generated aliases dispatch through real forge-tools behavior', () => {
