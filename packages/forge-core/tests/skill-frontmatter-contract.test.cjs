...
// The commands/forge/*.md and forge-core/workflows/*.md files are the
...
// ─── #3042: --research-phase flag wired into /forge-plan-phase ────────────────
// (Moved from bug-3042-3044-research-flag-and-stale-refs.test.cjs)

describe('skill frontmatter: /forge-plan-phase --research-phase flag absorbs the standalone research command', () => {
  test('commands/forge/plan-phase.md argument-hint advertises --research-phase', () => {
    const content = read('commands/forge/plan-phase.md');
  ...
  test('workflows/plan-phase.md parses --research-phase and sets a research-only mode', () => {
    const content = read('forge-core/workflows/plan-phase.md');
  ...
  test('orphaned workflows/research-phase.md is removed', () => {
    assert.equal(
      exists('forge-core/workflows/research-phase.md'),
      false,
      'workflows/research-phase.md must be removed; the capability now lives on /forge-plan-phase --research-phase'
    );
  });
