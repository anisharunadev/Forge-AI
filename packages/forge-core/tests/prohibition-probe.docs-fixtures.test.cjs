...
//
// RED-first parity contract: the portable reference doc (forge-core/references/prohibition-probe.md) keeps
// its worked-example JSON blocks in sync with the source-of-truth fixture files under
// forge-core/references/prohibition-probe-fixtures/. The fixtures are the canonical data; the doc embeds
...
const docPath = path.join(__dirname, '..', 'forge-core', 'references', 'prohibition-probe.md');
const fixturesRoot = path.join(__dirname, '..', 'forge-core', 'references', 'prohibition-probe-fixtures');
