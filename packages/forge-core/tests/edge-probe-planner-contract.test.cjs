...
const PROMPT_PATH = path.join(__dirname, '..', 'forge-core', 'templates', 'planner-subagent-prompt.md');
...
// which nothing loads at runtime (no @-import in agents/forge-planner.md, no read in plan-phase.md).
