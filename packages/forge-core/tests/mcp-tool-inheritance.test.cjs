...
describe('MCP tool usage in GSD agents', () => {
  const agentFiles = [
    path.join(__dirname, '..', 'agents', 'forge-executor.md'),
    path.join(__dirname, '..', 'agents', 'forge-planner.md'),
  ];
  ...
  test('forge-executor.md explicitly instructs to use available MCP tools', () => {
...
describe('Researcher agents declare mcp__tavily/ref/jina tools (#657)', () => {
  const researcherAgents = [
    path.join(__dirname, '..', 'agents', 'forge-project-researcher.md'),
    path.join(__dirname, '..', 'agents', 'forge-phase-researcher.md'),
    path.join(__dirname, '..', 'agents', 'forge-ui-researcher.md'),
  ];
...
describe('researcher Step-C dispatch ↔ tools frontmatter parity (#1284)', () => {
  const RESEARCHERS = ['forge-phase-researcher', 'forge-project-researcher'];
