 ...
 *
 * Seam: forge-core/workflows/cleanup.md
 *
 * Verifies that /forge-cleanup prunes local branches whose upstream is gone,
...
const CLEANUP_PATH = path.join(REPO_ROOT, 'forge-core', 'workflows', 'cleanup.md');
