 ...
 *
 * Module: forge-core/bin/lib/probe-core.cjs (generated from src/probe-core.cts)
...
const BUILT_SCRIPT = path.join(__dirname, '..', 'forge-core', 'bin', 'lib', 'probe-core.cjs');
...
const fm = require(path.join(__dirname, '..', 'forge-core', 'bin', 'lib', 'frontmatter.cjs'));
const enforce = require(path.join(__dirname, '..', 'forge-core', 'bin', 'lib', 'prohibition-enforcement.cjs'));
