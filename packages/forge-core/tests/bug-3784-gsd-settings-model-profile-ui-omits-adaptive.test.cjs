 ...
 *
 * /forge-settings model profile UI omits `adaptive`. The AskUserQuestion block
 ...
 * reachable by name via `forge:config --profile adaptive` but cannot be selected
 * interactively through `/forge:settings`.
 *
