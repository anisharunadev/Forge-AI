 ...
 *
 * `managed-hooks-registry.cjs` is shipped alongside forge-check-update-worker.js
...
describe('bug #941 — managed-hooks-registry.cjs recorded in file manifest', () => {
  ...
  beforeEach(() => {
    tmpDir = createTempDir('forge-bug-941-');
  });
  ...
  test('managed-hooks-registry.cjs appears in forge-file-manifest.json after install', () => {
    runInstaller(tmpDir);
  ...
  test('forge-file-manifest.json covers the full HOOKS_TO_COPY set (forward-proof)', () => {
    runInstaller(tmpDir);
