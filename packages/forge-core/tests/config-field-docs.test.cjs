...
const REFERENCE_PATH = path.join(__dirname, '..', 'forge-core', 'references', 'planning-config.md');
const CORE_PATH = path.join(__dirname, '..', 'forge-core', 'bin', 'lib', 'config-loader.cjs');
