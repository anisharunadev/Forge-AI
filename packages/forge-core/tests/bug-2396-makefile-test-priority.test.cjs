...
const VERIFY_PHASE_PATH = path.join(__dirname, '..', 'forge-core', 'workflows', 'verify-phase.md');
const AUDIT_FIX_PATH = path.join(__dirname, '..', 'forge-core', 'workflows', 'audit-fix.md');
