...
// the block-name-generic parseMustHavesBlock @ src/frontmatter.cts:207 (built to forge-core/bin/lib/
...
const FRONTMATTER_LIB = path.join(__dirname, '..', 'forge-core', 'bin', 'lib', 'frontmatter.cjs');
