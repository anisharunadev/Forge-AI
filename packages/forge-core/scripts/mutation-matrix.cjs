 ...
 *     "matrix": {
 *       "include": [
 *         { "name": "<module>", "mutate": "forge-core/bin/lib/<module>.cjs", "tests": "<space-joined test files>" },
 *         ...
 *       ]
 *     }
 *   }
...
const COVERED = {
  'context-utilization': {
    cjs: 'forge-core/bin/lib/context-utilization.cjs',
    tests: [
  ...
  'prompt-budget': {
    cjs: 'forge-core/bin/lib/prompt-budget.cjs',
    tests: [
  ...
  frontmatter: {
    cjs: 'forge-core/bin/lib/frontmatter.cjs',
    tests: [
  ...
  'adr-parser': {
    cjs: 'forge-core/bin/lib/adr-parser.cjs',
    tests: [
  ...
  'config-schema': {
    cjs: 'forge-core/bin/lib/config-schema.cjs',
    tests: [
  ...
  'active-workstream-store': {
    cjs: 'forge-core/bin/lib/active-workstream-store.cjs',
    tests: [
  ...
  'core-utils': {
    cjs: 'forge-core/bin/lib/core-utils.cjs',
    tests: [
