 ...
 * `get-shit-done` now that the package has been renamed to `forge-core` (#604).
 *
 ...
 *   - Lines containing the marker `forge-allow-legacy-name` (intentional uses)
...
const ALLOW_MARKER = 'forge-allow-legacy-name';
...
function main() {
  ...
  process.stderr.write('\n');
  process.stderr.write('Fix: rename to forge-core, or add `forge-allow-legacy-name` marker on the line if the\n');
