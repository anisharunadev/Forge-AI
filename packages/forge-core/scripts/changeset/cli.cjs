...
} = require('../../forge-core/bin/lib/semver-compare.cjs');
const { packageName, repoSlug: defaultRepoSlug } = require('../../forge-core/bin/lib/package-identity.cjs');
 ...
 * `/forge-update` show_changes_and_confirm step no longer relies on
