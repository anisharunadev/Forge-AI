...
/**
 * gen-plugin-skills.cjs — generates skills/forge-<stem>/SKILL.md from
 * commands/forge/*.md using convertClaudeCommandToClaudeSkill.
 *
 * Usage:
 ...
 * in commands/forge/*.md (command frontmatter); this script converts each to
 ...
 *
 * Depends on: forge-core/bin/lib/runtime-artifact-conversion.cjs (compiled from
...
const CONVERSION_MODULE = path.join(ROOT, 'forge-core', 'bin', 'lib', 'runtime-artifact-conversion.cjs');
const PREFIX = 'forge-';
