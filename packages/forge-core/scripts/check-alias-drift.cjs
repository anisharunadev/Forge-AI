...
const aliasesPath = path.join(ROOT, 'forge-core', 'bin', 'lib', 'command-aliases.cjs');
  ...
  const families = [
    {
      ...
      routerPath: path.join(ROOT, 'forge-core', 'bin', 'lib', 'state-command-router.cjs'),
    },
    {
      commandAliases: 'VERIFY_COMMAND_ALIASES',
      subcommands: 'VERIFY_SUBCOMMANDS',
      routerPath: path.join(ROOT, 'forge-core', 'bin', 'lib', 'verify-command-router.cjs'),
    },
    {
      commandAliases: 'INIT_COMMAND_ALIASES',
      subcommands: 'INIT_SUBCOMMANDS',
      routerPath: path.join(ROOT, 'forge-core', 'bin', 'lib', 'init-command-router.cjs'),
    },
    {
      commandAliases: 'PHASE_COMMAND_ALIASES',
      subcommands: 'PHASE_SUBCOMMANDS',
      routerPath: path.join(ROOT, 'forge-core', 'bin', 'lib', 'phase-command-router.cjs'),
    },
    {
      commandAliases: 'PHASES_COMMAND_ALIASES',
      subcommands: 'PHASES_SUBCOMMANDS',
      routerPath: path.join(ROOT, 'forge-core', 'bin', 'lib', 'phases-command-router.cjs'),
    },
    {
      commandAliases: 'VALIDATE_COMMAND_ALIASES',
      subcommands: 'VALIDATE_SUBCOMMANDS',
      routerPath: path.join(ROOT, 'forge-core', 'bin', 'lib', 'validate-command-router.cjs'),
    },
    {
      commandAliases: 'ROADMAP_COMMAND_ALIASES',
      subcommands: 'ROADMAP_SUBCOMMANDS',
      routerPath: path.join(ROOT, 'forge-core', 'bin', 'lib', 'roadmap-command-router.cjs'),
    },
  ];
