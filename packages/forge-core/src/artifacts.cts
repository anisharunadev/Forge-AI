 ...
 * are added.
 *
 * Enumerates the file names that forge workflows officially produce at the
 * .planning/ root level. Used by forge-health (W019) to flag unrecognized files
...
export const CANONICAL_PATTERNS: ReadonlyArray<RegExp> = [
  /^v\d+\.\d+(?:\.\d+)?-MILESTONE-AUDIT\.md$/i, // forge-complete-milestone (pre-archive)
