...
function versionFile(dir: string): string { return path.join(dir, 'forge-core', 'VERSION'); }
function markerFile(dir: string): string { return path.join(dir, 'forge-core', 'workflows', 'update.md'); }
