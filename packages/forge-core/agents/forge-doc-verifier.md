...
Spawned by the `/forge:docs-update` workflow. Each spawn receives a `<verify_assignment>` XML block containing:
...
- **GSD marker**: The comment `<!-- generated-by: forge-doc-writer -->` — skip entirely.
