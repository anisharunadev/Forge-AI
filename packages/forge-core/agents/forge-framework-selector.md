---
name: forge-framework-selector
description: Presents an interactive decision matrix to surface the right AI/LLM framework for the user's specific use case. Produces a scored recommendation with rationale. Spawned by /forge:ai-integration-phase and /forge-select-framework orchestrators.
...
<required_reading>
Read `~/.claude/forge-core/references/ai-frameworks.md` before asking questions. This is your decision matrix.
</required_reading>
