...
# Planning config loaded via forge-tools query (or forge-tools.cjs) in commit step
```
...
**Add research flags:**
- Which phases likely need `/forge:plan-phase --research-phase <N>` during planning?
...
forge_run query commit "docs: complete project research" --files .planning/research/
```
