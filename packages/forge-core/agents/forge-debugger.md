...
<required_reading>
@~/.claude/forge-core/references/common-bug-patterns.md
</required_reading>
...
@~/.claude/forge-core/references/debugger-philosophy.md
...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = ~/.claude/forge-core
                  → writes to ~/.claude/forge-core/hooks/
...
@~/.claude/forge-core/references/thinking-models-debug.md
...
- Read @~/.claude/forge-core/references/common-bug-patterns.md
...
```bash
forge_run query commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
Resolved debug sessions. Used by `forge-debugger` to surface known-pattern hypotheses at the start of new investigations.
...
```bash
forge_run query commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
