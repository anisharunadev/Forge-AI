...
<reference>
@~/.claude/forge-core/references/user-profiling.md
...
Read the user-profiling reference document at `~/.claude/forge-core/references/user-profiling.md` to load:
