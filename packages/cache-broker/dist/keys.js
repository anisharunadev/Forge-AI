...
export function deriveKey(parts) {
    if (!parts.resource)
        throw new Error('deriveKey: resource is required');
    if (!parts.id)
        throw new Error('deriveKey: id is required');
