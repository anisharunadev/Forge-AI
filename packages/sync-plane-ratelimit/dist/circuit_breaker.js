...
export class CircuitBreaker {
    ...
    transitions = [];
    constructor(opts) {
        if (opts.failure_threshold <= 0)
            throw new Error('circuit_breaker: threshold must be > 0');
        if (opts.cooldown_ms < 0)
            throw new Error('circuit_breaker: cooldown_ms must be >= 0');
