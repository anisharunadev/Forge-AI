...
FORA's typed event bus — 19 event types, NATS JetStream producer/consumer with per-tenant subject isolation, SQS+SNS bridge contract, and replay from `agent_run_events`.

**Implements:** [FORA-136](/FORA/issues/FORA-136) · **Sub-goal 0.1.3 of** [FORA-50](/FORA/issues/FORA-50) · **Substrate:** [ADR-0006](/FORA/docs/architecture/adr-0006-event-bus-nats-jetstream.md) · **Spec:** [FORA-50 spec §5](/FORA/issues/FORA-50)
...
Per [FORA-50 spec §5.1](/FORA/issues/FORA-50):
...
const nc = await connect({ servers: process.env.FORA_NATS_URL! });
