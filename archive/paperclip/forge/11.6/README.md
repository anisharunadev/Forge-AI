...
Day-one P0 sub-goal of [Epic 11 — Forge Integration Layer](/Forge AI/issues/Forge AI-249).
Implements [ADR-0010 §7.1](/Forge AI/docs/architecture/adr-0010-cross-platform-sync-plane.md) and
