...
| Field            | Value                                                                                                              |
|------------------|--------------------------------------------------------------------------------------------------------------------|
| **Sub-goal of**  | [Forge AI-249 Epic 11 — Forge Integration Layer](../../issues/Forge AI-249)                                              |
...
DocAgent handoff (Forge AI-7 / Knowledge Layer §0 — typography, spacing,
...
| AC from Forge AI-255                                                           | Where it is satisfied                                                                                |
|----------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|
...
| Designer handoff per Forge AI-7 DocAgent style (Knowledge Layer §0 conventions) | §4 column set, empty state, confirm modal, pattern panel — all DocAgent primitives                  |
...
- Forge AI-11.4 (id `be1c6eef-…`) — Tier-1/Tier-2 resolver; live `in_progress`
- Forge AI-11.0 (id `a1fe46f5-…`) — Architect hire; live `in_progress`
- Forge AI-36 audit forwarder — audit row consumer; hash-chain + SOC 2 export
