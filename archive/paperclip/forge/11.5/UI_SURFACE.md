...
| Field            | Value                                                                                                              |
|------------------|--------------------------------------------------------------------------------------------------------------------|
| **Sub-goal of**  | [Forge AI-255 (11.5 — Tier-3 Divergence Workbench)](../../issues/Forge AI-255)                                             |
| **Status**       | **todo** — dispatched after Forge AI-11.0 Architect hire closes (per design.md §9)                                     |
| **Author**       | Architect (this sub-task: 11.5a)                                                                                   |
| **Reviewer**     | Designer + CTO                                                                                                     |
| **Blocks**       | Epic 11 ship gate (Forge AI-249 §11.5 exit)                                                                            |
| **Blockers**     | Forge AI-11.0 (Architect hire); Forge AI-255 v0.1 contract acceptance                                                       |
...
(Next.js 15 App Router; the workspace has `apps/forge/` from Forge AI-374
...
ACs from Forge AI-255 are upstream; this child proves them end-to-end.
...
- Tier 3 detection itself (Forge AI-11.4 / `agents/sync_plane/resolver.py`).
- Production Postgres / JetStream wiring of `enqueue_divergence`
  (one-line substitution at the call site; non-trivial only when
  Forge AI-11.4's `__init__.py` indentation error is fixed).
...
- Forge AI-249 Epic 11 — parent Epic, sub-task map §11.5
- Forge AI-7 / DocAgent — design-system primitives (`DataPanel`, `DiffPair`,
  `confirm_destructive`)
- Forge AI-374 — Forge AI console (Next.js 15 persona dashboards; the
