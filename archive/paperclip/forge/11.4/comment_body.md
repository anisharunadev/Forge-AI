## Forge AI-254 — v0.1 shipped (CTO-authored, Architect TBD)

Shipped the Tier 1 / Tier 2 / Tier 3 conflict resolver per
[ADR-0010 §4](/Forge AI/docs/architecture/adr-0010-cross-platform-sync-plane.md).
...
### What's NOT shipped in v0.1 (deliberate, per Forge AI-254 scope)
...
PATCHing `Forge AI-254` → `in_review` with a `request_confirmation`
