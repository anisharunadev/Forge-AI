# Forge AI-83 / Sub-goal 8.2 — Dependency Graph Schema

> **Status:** v0.1 — `dep-graph/0.1.0` (schema v1)
> **Source:** `agents.refactor.build_graph` (Forge AI-83 / 8.2)
> **Consumers:** [Forge AI-84](/Forge AI/issues/Forge AI-84) (8.3 AWS Transform orchestration), [Forge AI-85](/Forge AI/issues/Forge AI-85) (8.4 migration planner + Jira)
> **Upstream:** [Forge AI-82](/Forge AI/issues/Forge AI-82) (8.1 Code analyzer — provides `MigrationScope` and the normalised `RepoScope`)
