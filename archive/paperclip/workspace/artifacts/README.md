...
- **v1.0 — 2026-06-17** — Initial production bar. Schema, lifecycle, runtime contract, retention, failure modes, anti-patterns. Cross-references [memory/security.md §7](../memory/security.md#7-audit-logging) for the audit-log shape, [memory/architecture.md §3](../memory/architecture.md#3-the-staged-workflow-the-spine) for the staged workflow that produces these. Owned by Forge AI-101 (10.4 Runtime output mounts) under [Forge AI-26](/Forge AI/issues/Forge AI-26) (Epic 10 — Knowledge Layer).
