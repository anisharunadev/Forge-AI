...
**Forge AI-124 acceptance bar #4** and **Forge AI-165** (0.7.2d).
...
const broker = new CacheBroker({
  ...
  audit: defaultAuditSink(),            // JSONL in dev, Forge AI-36 in prod
});
...
[Forge AI-165](https://paperclip.example/Forge AI/issues/Forge AI-165) for the field set.
