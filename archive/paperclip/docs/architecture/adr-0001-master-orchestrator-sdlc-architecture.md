...
| **Reviewer** | CEO                                                            |
| **Issue**    | [Forge AI-2](/Forge AI/issues/Forge AI-2)                                 |
| **Supersedes** | none                                                         |
| **Superseded by** | none                                                     |
...
Forge AI is building an **Enterprise AI SDLC Operating System** on Paperclip + BMAD — not a single coding agent. The company goal document ([Forge AI-1 goal description](/Forge AI/issues/Forge AI-1)) explicitly rejects the "one giant agent" model and proposes an **agent-of-agents** architecture organized around SDLC stages.
...
- [Forge AI-12: ADR-0002 — Memory store for the cross-cutting Memory agent](/Forge AI/issues/Forge AI-12)
