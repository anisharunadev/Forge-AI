...
`tests/devops/test_audit_completeness.py` (Forge AI-214).
...
| Audit chain broken | `tests/devops/test_audit_completeness.py` will tell you which `audit_log_entry_id` is missing. The audit-sink forwarder is `audit/` (Forge AI-36). |
