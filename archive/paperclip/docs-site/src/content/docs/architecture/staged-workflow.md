...
Wired in [Forge AI-173](/Forge AI/issues/Forge AI-173). The handoff contract is the schema; the `StageEngine` is the runtime. A change to either side without updating the other is a **contract drift bug**.
