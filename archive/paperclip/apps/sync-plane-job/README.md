...
- **Forge AI-438 AC#5** — nightly cron over the GitHub
  divergence path. The shared worker pattern means
  Forge AI-406 (Jira) divergences go through the same scan.
- **Forge AI-204** — the audit forwarder owns the
...
## Out of scope (per the Forge AI-200 charter)
