...
**Issue:** [Forge AI-254](/Forge AI/issues/Forge AI-254) (Sub-goal 11.4 of Epic 11)
...
This module is the Forge AI-254 deliverable: a config-driven conflict
resolver that:
...
## Out of scope (deliberately, for Forge AI-254)
