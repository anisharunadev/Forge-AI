...
# 3. UI banner cleared
# Visit http://localhost:3000 in a brows/goal
...
- "What we deliberately did NOT change" — keep Step 12's markdown editor, keep F-001/F-002/F-003 numbering convention, don't break existing artifacts data modeler; LLMUnavailableBanner is gone.
```
