...
**Parent:** [FORA-16 Epic 0 — Forge AI Platform Foundation](/FORA/issues/FORA-16)
...
## 12. Definition of done (for FORA-36)

FORA-36 (this design) is `done` when:
...
FORA-36 is **not** the implementation. Implementation lives in the child issues.
