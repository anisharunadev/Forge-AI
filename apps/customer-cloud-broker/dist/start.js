...
import { ProbeProbeSigner } from './probe-signer.js';
...
export async function start() {
    ...
    const probe_interval_ms = Number(process.env.FORA_CCB_PROBE_INTERVAL_MS ?? PROBE_INTERVAL_MS_DEFAULT);
    ...
    // eslint-disable-next-line no-console
    console.log(`[customer-cloud-broker] listening on ${config.listen_host}:${config.listen_port} (probe every ${probe_interval_ms}ms)`);
}
/**
 ...
 */
async function loadProbeSigningKey() {
