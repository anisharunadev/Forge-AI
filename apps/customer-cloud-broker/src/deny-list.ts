...
export function loadDenyList(source: string, opts: LoadOptions = {}): DenyList {
...
export class DenyListMatcher {
  private readonly entries: Array<{ cloud: Cloud; action: string; re: RegExp; reason: string | null }>;
 ...
 */
export function buildDenyListMatcher(source: string, opts: LoadOptions = {}): {
  list: DenyList;
