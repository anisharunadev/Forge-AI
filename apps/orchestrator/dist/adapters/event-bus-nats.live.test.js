...
import { NatsApprovalEventBus, natsProducerFactoryFor, openNatsConnection, } from './event-bus-nats.js';
...
describe.skipIf(skip)('NatsApprovalEventBus — live NATS', () => {
    ...
    it('publishes approval_requested and a tenant-A consumer reads it back', async () => {
        ...
        const env = tenantAReceived[tenantAReceived.length - 1];
...
//# sourceMappingURL=event-bus-nats.live.test.js.map