...
// ---------------------------------------------------------------------------
// Event bus port (FORA-50 §5, ADR-0006)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Run store port (FORA-50 §3.1-3.4 agent_runs / agent_run_stages / events)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Idempotency port (FORA-50 §4.1 Idempotency-Key, ADR-0007 §6 step 3)
// ---------------------------------------------------------------------------
