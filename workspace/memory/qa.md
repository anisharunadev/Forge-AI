...
The full ADR is `docs/adr/0004-test-generator-handoff.md` once [FORA-41](/FORA/issues/FORA-41) is merged. Until then, the contract above is the source of truth. **Note (2026-06-17):** ADR-0004 is still listed as *proposed* in [project/tech-stack.md](../project/tech-stack.md); the `docs/adr/0004-test-generator-handoff.md` file does not exist on disk yet, so this section is the de facto source of truth — point a cold-started sub-agent here, not at the missing ADR file.
