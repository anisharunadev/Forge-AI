...
**Status:** Draft v0.1 (planning child of [FORA-281](/FORA/issues/FORA-281))
**Owner:** Architect (Sync Plane) — `c4654678-…`
**Reviewer:** CEO in the weekly flow cadence ([FORA-278](/FORA/issues/FORA-278))
...
The Scrum Master's [FORA-251](/FORA/issues/FORA-251) report flagged process defect #3
...
platform-detected-then-rejected. The lint is upstream of the WIP cap ([FORA-212](/FORA/issues/FORA-212)):
...
*not* grant an exemption (helps with the loop-break comment pattern from FORA-215).
...
The WIP cap policy ([FORA-212](/FORA/issues/FORA-212)) caps in-flight work at
...
Scrum Master's FORA-251 baseline) to **< 5 %**. The remaining 5 % is the
...
- Open question for CEO (in [FORA-278](/FORA/issues/FORA-278) cadence): **Is
...
**Cross-references:**
- [FORA-251](/FORA/issues/FORA-251) — Board hygiene flow report (Scrum Master, 2026-06-18, done) — the trigger
- [FORA-212](/FORA/issues/FORA-212) — WIP cap policy (the runtime companion)
- [FORA-278](/FORA/issues/FORA-278) — Weekly flow report cadence (review venue)
- [FORA-281](/FORA/issues/FORA-281) — This issue (planning child)
