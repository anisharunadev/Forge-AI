# `forge-ai/mcp-sonarqube` — Forge AI SonarQube MCP Server
...
This package is built from the `forge-ai/mcp-github` template ([Forge AI-4](/Forge AI/issues/Forge AI-4), [template note](docs/template-note.md)). The seven contract points in that template-note are mandatory and non-negotiable.
