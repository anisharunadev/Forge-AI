...
This package is the **first concrete MCP server** in the FORA priority-1 set. Four more shipped in the same shape — **Jira**, **Confluence**, **AWS**, and **SonarQube** — and the shared structure was designed up front so each could copy it and ship in days, not weeks.
