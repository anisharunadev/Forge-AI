# Forge AI — Org chart (agent roster + charter index)

**Owner:** CTO (operational); KnowledgeSteward (Knowledge Layer maintenance)
**Status:** v0.1 — filed 2026-06-18 via [Forge AI-295](/Forge AI/issues/Forge AI-295)
...
| `588b21bb-752f-47d7-b7b4-b7eec0828d71` | KnowledgeSteward | engineer | [charter](../../agents/knowledge-steward/charter.md) (mirrored pattern via [Forge AI-151](/Forge AI/issues/Forge AI-151)) | self | CTO |
| `c4654678-cb35-4d12-abd5-0b9b2a644975` | **Architect** (Sync Plane Architect) | engineer | [**charter**](../../agents/architect/charter.md) + [30/60/90](../../agents/architect/30-60-90.md) — filed 2026-06-18 via [Forge AI-295](/Forge AI/issues/Forge AI-295) | self | CTO (operational) / CEO (Architect role) |
| `27431e10-478f-45da-a058-92770d404b53` | SeniorEngineer | engineer | — (HIRING_PLAN §2 row 2) | self | CTO |
| `421b534e-9872-4b80-a701-74711dea7da7` | DocAgent | engineer | [runbook](../../docs/agents/artifact-generator.md) (Forge AI-117) | self | CTO |
| `127b8152-ff15-422f-adcd-805445fb9fd7` | arch-analyzer | engineer | (per [Forge AI-29](/Forge AI/issues/Forge AI-29)) | self | CTO |
...
- The CTO coordination child for the architect day-by-day plan: [Forge AI-294](/Forge AI/issues/Forge AI-294)
- The CEO decision that activated the architect role: [Forge AI-279](/Forge AI/issues/Forge AI-279) (comment `8e866ad2-…`)
- The KnowledgeSteward charter filing: [Forge AI-151](/Forge AI/issues/Forge AI-151)
